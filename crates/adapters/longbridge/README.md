...
explicit sample `AAPL.US` equity because the adapter does not infer tick size or lot-size rules.
Verify every instrument definition before connecting, and review the execution warning before
changing the paper-trading default.
